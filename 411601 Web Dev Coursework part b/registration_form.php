    ...
    <meta name = " viewport" content = "width=device-width, initial-scale = 1">
     ...
     <style type="text/css">
      ...
      <body>
        ...
        $first_name = $last_name = $username = $email = $gender = $pwd = $confirm_password = $interest = "";

        $first_nameErr = $last_nameErr = $usernameErr = $emailErr = $genderErr = "";
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (empty($_POST["last_name"])) {
                ...
                $last_nameErr = test_input($_POST["last_name"]);
        ...
        <form method="post" action="includes/formhandler.inc.php">
            ...
            <span class="error">* required field<?php echo $first_nameErr;?></span>
            <br><br>
            Last Name: <input type="text" name="last_name"><br>
            Username: <input type="text" name= "username"><br>
            E-mail: <input type="text" name="email"><br>
            Confirm E-mail: <input type="text" name="confirm_email"><br>
